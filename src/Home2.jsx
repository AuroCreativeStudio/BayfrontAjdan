    ...
    return (
        <>
            <div className={`relative w-full ${isScrollable ? "overflow-y-auto" : "h-screen overflow-hidden"}`}>
                ...
                <section
                    ref={heroSectionRef}
                    className={`relative w-full ${isScrollable ? "h-screen sticky top-0" : "fixed h-screen"
                        }`}
      ...
      ">
        ...
        "
                    ...
                    {/* <div className="hidden md:block lg:hidden tablet-layout">
                        <article className="tablet-text">
                            <p>Bayfront brings forward the beach experience...</p>
                        </article>
                        <div className="tablet-leaves">
                    ...
                    <div className="block md:hidden mobile-layout">
                        <article className="mobile-text">
                            <p className="font-FocoLight text-[#977d68] text-[25px]">Bayfront brings forward the
                                beach experience the way it is
                                meant to be experienced.
                                Fronting the beautiful Khobar
                                shoreline, the beach at Bayfront
